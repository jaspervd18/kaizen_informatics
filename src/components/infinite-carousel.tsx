  ...
  return (
    <div className="flex w-full items-center justify-center">
      <div className="relative w-full max-w-screen-lg overflow-hidden">
        ...
        <div className="corner top-left dark:bg-gradient-dark" />
        <div className="corner top-right dark:bg-gradient-dark" />
        <div className="corner bottom-left dark:bg-gradient-dark" />
        <div className="corner bottom-right dark:bg-gradient-dark" />
